...
namespace GymManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260818004925_AddPlanSoftDeleteAndMembershipAutoRenew")]
    partial class AddPlanSoftDeleteAndMembershipAutoRenew
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.Inscription", b =>
                {
                    ...
                    b.Property<DateTime?>("AttendanceRecordedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("GymManagement.Domain.Entities.GymClass", b =>
                {
                    ...
                    b.HasOne("GymManagement.Domain.Entities.User", "Trainer")
                        .WithMany()
